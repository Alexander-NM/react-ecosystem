...
export default function ExpenseForm({
    ...
    async function deleteExpenseHandler() {
        ...
        try {
            setIsFetching(true)
            await deleteExpense(expenseId) // Handle the HTTP request to Firebase
            expensesContext.deleteExpense(expenseId)
            navigation.goBack()
        } catch (error) {
            expensesContext.setError("Failed to delete expense.")
        } finally {
            setIsFetching(false)
        }
    }
    ...
    async function addHandler() {
        ...
        try {
            setIsFetching(true)
            const id = await storeExpense(expense) // Handle the HTTP request to Firebase
            expensesContext.addExpense({ ...expense, id })
            navigation.goBack()
        } catch (error) {
            expensesContext.setError("Failed to add expense.")
        } finally {
            setIsFetching(false)
        }
    }
    ...
    async function updateHandler() {
        ...
        try {
            setIsFetching(true)
            await updateExpense(expense) // Handle the HTTP request to Firebase
            ...
            expensesContext.setError("Failed to update expense.")
        } finally {
            setIsFetching(false)
        }
    }
